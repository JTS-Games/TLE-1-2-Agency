<x-layout title="Account aanmaken">
    <div class="flex items-center justify-center py-10">
        <form method="POST" action="{{ route('register') }}"
            ...
            <h1 class="text-2xl text-[#2F4F4F] font-bold mb-6 text-center">Account aanmaken</h1>

            <div class="mb-4">
                <x-input-label for="name" :value="__('Naam')" class="text-sm font-medium text-gray-700"/>
