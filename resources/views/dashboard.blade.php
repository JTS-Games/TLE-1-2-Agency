        ...
        <div class="max-w-lg mx-auto px-4">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 text-center">
                    <a href="{{ route('profile.edit') }}" class="inline-block w-1/2 bg-primary-yellow text-primary-violet font-semibold py-3 px-6 rounded-md hover:bg-primary-violet transition hover:text-white duration-200">
                        Profiel gegevens
                    </a>
                </div>
            </div>
