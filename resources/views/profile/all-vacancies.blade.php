    ...
    <form action="{{ route('vacancies.index') }}" method="GET" class="max-w-lg mx-auto my-10">
        ...
        <div class="relative w-full flex items-center mb-6">
            ...
            <input type="search" id="search" name="search" value="{{ request('search') }}"
                   class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                   placeholder="Zoek op locatie, salaris of naam"/>
        </div>
            ...
            <div
                ...
                <div>
                    ...
                    <h2 class="text-lg font-semibold text-gray-700 mb-4">
                        <b>Contractduur:</b> {{$vacancy->contract_term}} maanden</h2>
                </div>
