<nav>
    <div class="flex flex-col md:flex-row justify-evenly items-center space-y-4 md:space-y-0 md:space-x-4">
        <!-- Logo at the top -->
        <a href="{{route('index')}}" class="order-none">
        ...
        <a href="#"
           class="bg-primary-violet text-white rounded-full px-6 py-2 hover:bg-primary-yellow hover:text-primary-violet hover:duration-200">
            Over Open Hiring
        </a>
